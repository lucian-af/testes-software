...
Cenário: 1 Adicionar item com sucesso a um novo pedido
...
Cenário: 2 Adicionar items acima do limite
	Dado Que um produto esteja na vitrine
	E Esteja disponivel no estoque	
...
Cenário: 3 Adicionar item já existente no carrinho
	Dado Que um produto esteja na vitrine
	E Esteja disponivel no estoque	
...
Cenário: 4 Adicionar item já existente onde soma ultrapassa limite máximo
	Dado Que um produto esteja na vitrine
	E Esteja disponivel no estoque	
	E O mesmo produto já tenha sido adicionado ao carrinho anteriormente
